...
const refConversationQualityRunDaily = makeFunctionReference<"action">("conversationQualityActions:runDaily");
...
crons.interval("conversation-quality-review", { hours: 24 }, refConversationQualityRunDaily, {
  maxThreads: 30,
});
