...
const CHECKIN_PROMPT_PATTERNS: RegExp[] = [
  ...
  /\bhow body now\b/i,
  /\bhow far\b/i,
  /\b(are|r) (you|u) (good|okay|ok|alright)\b/i,
  /\b(you|u) (good|okay|ok|alright)\??\b/i,
  /\bchecking in( on you)?\b/i,
  /\bchecking on you\b/i,
  /\bhope (you|u) (are|dey|feel(?:ing)?) (okay|ok|fine|alright|good)\b/i,
  /\bhope (you|u)(?:'|’)re holding up\b/i,
  /\b(you|u)(?:'|’)?ve been quiet\b/i,
  /\bjust checking\b/i,
  /\byou dey (okay|ok|alright)\b/i,
];
