...
export const convexRefs = {
  ...
  storefrontSearchProductsForSelling: makeFunctionReference<"query">("storefront:searchProductsForSelling"),
  storefrontAdminPayoutOps: makeFunctionReference<"query">("storefront:adminPayoutOps"),
  storefrontAdminCreateWeekendPayoutBatch: makeFunctionReference<"mutation">("storefront:adminCreateWeekendPayoutBatch"),
  storefrontAdminSetPayoutAccountStatus: makeFunctionReference<"mutation">("storefront:adminSetPayoutAccountStatus"),
  storefrontAdminPreparePayoutBatchTransfers: makeFunctionReference<"mutation">("storefront:adminPreparePayoutBatchTransfers"),
  storefrontAdminRecordPayoutTransferResult: makeFunctionReference<"mutation">("storefront:adminRecordPayoutTransferResult"),
  storefrontAdminMarkPayoutBatchPaid: makeFunctionReference<"mutation">("storefront:adminMarkPayoutBatchPaid"),
  ...
  adminPlatformSeedDefaultConfigs: makeFunctionReference<"mutation">("adminPlatform:seedDefaultConfigs"),
